      ...
      {result ? (
        <Stack>
          <Alert color="green" title="Restored">
            {result.uploads} image(s) restored. What was here before is saved on
            the server as <code>{result.safety}</code>.
          </Alert>
          <Table striped>
            <Table.Tbody>
        ...
        <Stack>
          ...
          >
            Every item, series, character, location, outfit version and image
            becomes what the backup holds. The current data is backed up on the
            server first.
          </Alert>
          <FileInput
            label="Backup file"
            placeholder="cosplay-closet-….tar.gz"
